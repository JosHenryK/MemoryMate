...
trigger_detector = triggerDetection.TriggerDetector()
...
def summarize_chat():
    ...
    return llm_gui.send_message(summary_prompt).text
...
def llm_process():
    ...
    result = llm_gui.send_message(conversation.get_conversation_text()).text
